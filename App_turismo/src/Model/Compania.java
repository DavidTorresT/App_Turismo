...
public class Compania {
	...
	public Compania(String razonsocial, String direccion, String correo, String telefono, String fechaCreacion,
			String web) {
		super();
	...
	public void update(int idcompania, String razonsocial, String direccion, String correo, String telefono, String fechacreacion, String web) {
		...
		try {
			...
			int rs = JOptionPane.showConfirmDialog(null, "Desea actuailzar el registro" + idcompania + "?");
