...
public class Clientes {
	...
	public Clientes(int tipodocumento, int documento, String nombres, String apellidos, String eps, String alergias,
	...
	// Consultar
	public void readOne(int idcliente, JTextField tipodocumento, JTextField documento, JTextField nombres,
	...
	// Actualizar
	public void update(int idcliente, String tipodocumento, int documento, String nombres, String apellidos,
		...
		try {
			...
			int rs = JOptionPane.showConfirmDialog(null, "Desea actuailzar el registro" + idcliente + "?");
