...
public class Medios {
	...
	// Actualizar
	public void update(int idmedios, String nombre, String observaciones) {
		Connection dbConnection = null;
		PreparedStatement pst = null; // Preparar la trx

		String script = "UPDATE tblmedios SET nombre = ?, observaciones = ? WHERE idmedios = ?";
		...
		try {
			...
			int rs = JOptionPane.showConfirmDialog(null, "Desea actuailzar el registro" + idmedios + "?");
